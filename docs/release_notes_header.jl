...
```@meta
EditURL = "https://github.com/EpiAware/ModifiedDistributions.jl/blob/main/NEWS.md"
```
...
See [GitHub Releases](https://github.com/EpiAware/ModifiedDistributions.jl/releases) for minor/patch
release information.
