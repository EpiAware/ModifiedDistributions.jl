...
# [`thin`](@ref) and [`cumulative`](@ref), the generic [`map_series`](@ref)
...
# 3. Use the generic [`map_series`](@ref) for an arbitrary series map.
...
# ## The generic map_series escape hatch
#
# [`map_series`](@ref) accepts any callable `series -> series`, for the cases
...
shift_op = ModifiedDistributions.map_series(delay, s -> s .+ 1.0)
