|                                                                                   | 98afb760f77906...   |
|:----------------------------------------------------------------------------------|:-------------------:|
| AD gradients/Affine LogNormal scale+shift logpdf/Enzyme forward                   | 8.43 ± 0.12 μs      |
| AD gradients/Affine LogNormal scale+shift logpdf/Enzyme reverse                   | 3.04 ± 0.061 μs     |
| AD gradients/Affine LogNormal scale+shift logpdf/ForwardDiff                      | 0.749 ± 0.093 μs    |
| AD gradients/Affine LogNormal scale+shift logpdf/Mooncake forward                 | 6.83 ± 0.31 μs      |
| AD gradients/Affine LogNormal scale+shift logpdf/Mooncake reverse                 | 18.3 ± 0.76 μs      |
| AD gradients/Affine LogNormal scale+shift logpdf/ReverseDiff (tape)               | 16.8 ± 0.47 μs      |
| AD gradients/Modified LogNormal identity-link logpdf/Enzyme forward               | 8.78 ± 0.1 μs       |
| AD gradients/Modified LogNormal identity-link logpdf/Enzyme reverse               | 5.95 ± 1.1 μs       |
| AD gradients/Modified LogNormal identity-link logpdf/ForwardDiff                  | 1.01 ± 0.023 μs     |
| AD gradients/Modified LogNormal identity-link logpdf/Mooncake forward             | 8.23 ± 0.17 μs      |
| AD gradients/Modified LogNormal identity-link logpdf/Mooncake reverse             | 0.0442 ± 0.0051 ms  |
| AD gradients/Modified LogNormal identity-link logpdf/ReverseDiff (tape)           | 0.0323 ± 0.00059 ms |
| AD gradients/Modified LogNormal log-link logpdf/Enzyme forward                    | 8.56 ± 0.09 μs      |
| AD gradients/Modified LogNormal log-link logpdf/Enzyme reverse                    | 3.56 ± 0.06 μs      |
| AD gradients/Modified LogNormal log-link logpdf/ForwardDiff                       | 0.912 ± 0.097 μs    |
| AD gradients/Modified LogNormal log-link logpdf/Mooncake forward                  | 7.51 ± 0.16 μs      |
| AD gradients/Modified LogNormal log-link logpdf/Mooncake reverse                  | 0.0411 ± 0.0041 ms  |
| AD gradients/Modified LogNormal log-link logpdf/ReverseDiff (tape)                | 26.9 ± 0.55 μs      |
| AD gradients/Product{Weighted} LogNormal vector logpdf/Enzyme forward             | 8.33 ± 0.16 μs      |
| AD gradients/Product{Weighted} LogNormal vector logpdf/Enzyme reverse             | 1.04 ± 0.23 μs      |
| AD gradients/Product{Weighted} LogNormal vector logpdf/ForwardDiff                | 0.882 ± 0.068 μs    |
| AD gradients/Product{Weighted} LogNormal vector logpdf/Mooncake forward           | 7.04 ± 1.2 μs       |
| AD gradients/Product{Weighted} LogNormal vector logpdf/Mooncake reverse           | 28.7 ± 2.7 μs       |
| AD gradients/Product{Weighted} LogNormal vector logpdf/ReverseDiff (tape)         | 16.8 ± 0.47 μs      |
| AD gradients/Thinned convolved series sum/Enzyme forward                          | 10.7 ± 0.17 μs      |
| AD gradients/Thinned convolved series sum/Enzyme reverse                          | 14.9 ± 0.19 μs      |
| AD gradients/Thinned convolved series sum/ForwardDiff                             | 3.27 ± 0.051 μs     |
| AD gradients/Thinned convolved series sum/Mooncake forward                        | 12.8 ± 0.44 μs      |
| AD gradients/Thinned convolved series sum/Mooncake reverse                        | 0.0339 ± 0.0052 ms  |
| AD gradients/Thinned convolved series sum/ReverseDiff (tape)                      | 0.0366 ± 0.00063 ms |
| AD gradients/Transformed cumulative LogNormal logpdf/Enzyme forward               | 8.1 ± 0.094 μs      |
| AD gradients/Transformed cumulative LogNormal logpdf/Enzyme reverse               | 2.03 ± 0.057 μs     |
| AD gradients/Transformed cumulative LogNormal logpdf/ForwardDiff                  | 0.524 ± 0.078 μs    |
| AD gradients/Transformed cumulative LogNormal logpdf/Mooncake forward             | 5.54 ± 0.27 μs      |
| AD gradients/Transformed cumulative LogNormal logpdf/Mooncake reverse             | 24.6 ± 7.1 μs       |
| AD gradients/Transformed cumulative LogNormal logpdf/ReverseDiff (tape)           | 15.3 ± 0.4 μs       |
| AD gradients/Transformed thin LogNormal logpdf/Enzyme forward                     | 8.07 ± 0.08 μs      |
| AD gradients/Transformed thin LogNormal logpdf/Enzyme reverse                     | 2 ± 0.056 μs        |
| AD gradients/Transformed thin LogNormal logpdf/ForwardDiff                        | 0.528 ± 0.077 μs    |
| AD gradients/Transformed thin LogNormal logpdf/Mooncake forward                   | 5.5 ± 0.27 μs       |
| AD gradients/Transformed thin LogNormal logpdf/Mooncake reverse                   | 24.4 ± 6.8 μs       |
| AD gradients/Transformed thin LogNormal logpdf/ReverseDiff (tape)                 | 15.3 ± 0.39 μs      |
| AD gradients/Weighted Affine LogNormal nested logpdf/Enzyme forward               | 8.31 ± 0.11 μs      |
| AD gradients/Weighted Affine LogNormal nested logpdf/Enzyme reverse               | 0.955 ± 0.075 μs    |
| AD gradients/Weighted Affine LogNormal nested logpdf/ForwardDiff                  | 0.793 ± 0.11 μs     |
| AD gradients/Weighted Affine LogNormal nested logpdf/Mooncake forward             | 7.33 ± 0.28 μs      |
| AD gradients/Weighted Affine LogNormal nested logpdf/Mooncake reverse             | 19.3 ± 0.82 μs      |
| AD gradients/Weighted Affine LogNormal nested logpdf/ReverseDiff (tape)           | 18.4 ± 0.44 μs      |
| AD gradients/Weighted LogNormal observation-time weight logpdf/Enzyme forward     | 8.03 ± 0.08 μs      |
| AD gradients/Weighted LogNormal observation-time weight logpdf/Enzyme reverse     | 1.28 ± 0.34 μs      |
| AD gradients/Weighted LogNormal observation-time weight logpdf/ForwardDiff        | 0.559 ± 0.074 μs    |
| AD gradients/Weighted LogNormal observation-time weight logpdf/Mooncake forward   | 6.01 ± 0.87 μs      |
| AD gradients/Weighted LogNormal observation-time weight logpdf/Mooncake reverse   | 29.7 ± 2.9 μs       |
| AD gradients/Weighted LogNormal observation-time weight logpdf/ReverseDiff (tape) | 17.5 ± 0.43 μs      |
| AD gradients/Weighted LogNormal scalar logpdf/Enzyme forward                      | 8.03 ± 0.073 μs     |
| AD gradients/Weighted LogNormal scalar logpdf/Enzyme reverse                      | 1.28 ± 0.34 μs      |
| AD gradients/Weighted LogNormal scalar logpdf/ForwardDiff                         | 0.553 ± 0.074 μs    |
| AD gradients/Weighted LogNormal scalar logpdf/Mooncake forward                    | 6 ± 0.67 μs         |
| AD gradients/Weighted LogNormal scalar logpdf/Mooncake reverse                    | 0.0363 ± 0.0033 ms  |
...
| AD gradients/Weighted Sequential observed-total logpdf/Enzyme reverse             | 0.342 ± 0.028 ms    |
| AD gradients/Weighted Sequential observed-total logpdf/ForwardDiff                | 0.0842 ± 0.00097 ms |
| AD gradients/Weighted Sequential observed-total logpdf/Mooncake forward           | 0.414 ± 0.022 ms    |
| AD gradients/Weighted Sequential observed-total logpdf/Mooncake reverse           | 1.28 ± 0.077 ms     |
| AD gradients/Weighted Sequential observed-total logpdf/ReverseDiff (tape)         | 2.39 ± 0.31 ms      |
| Affine/LogNormal/ccdf                                                             | 3.3 ± 0.38 μs       |
| Affine/LogNormal/cdf                                                              | 3.37 ± 0.37 μs      |
| Affine/LogNormal/construction                                                     | 3.1 ± 0.01 ns       |
| Affine/LogNormal/logpdf                                                           | 2.66 ± 0.34 μs      |
| Affine/LogNormal/pdf                                                              | 4.11 ± 0.36 μs      |
| Affine/LogNormal/quantile                                                         | 0.492 ± 0.017 μs    |
...
| Modified/IdentityLink/cdf                                                         | 7.22 ± 0.033 μs     |
| Modified/IdentityLink/construction                                                | 2.79 ± 0.01 ns      |
| Modified/IdentityLink/logpdf                                                      | 10.6 ± 0.12 μs      |
| Modified/IdentityLink/pdf                                                         | 12.7 ± 0.06 μs      |
| Modified/IdentityLink/quantile                                                    | 0.112 ± 0.00024 ms  |
| Modified/IdentityLink/rand                                                        | 0.576 ± 0.015 ms    |
| Modified/LogLink/ccdf                                                             | 5.81 ± 0.077 μs     |
| Modified/LogLink/cdf                                                              | 6.19 ± 0.076 μs     |
| Modified/LogLink/construction                                                     | 3.11 ± 0.92 ns      |
| Modified/LogLink/logpdf                                                           | 8.05 ± 0.036 μs     |
| Modified/LogLink/pdf                                                              | 9.42 ± 0.05 μs      |
| Modified/LogLink/quantile                                                         | 0.931 ± 0.071 μs    |
| Modified/LogLink/rand                                                             | 5.17 ± 0.2 μs       |
| Transformed/cumulative/cdf                                                        | 2.67 ± 0.33 μs      |
...
| Transformed/thin/rand                                                             | 1.03 ± 0.037 μs     |
| Weighted/Product/construction                                                     | 0.289 ± 0.19 μs     |
| Weighted/Product/logpdf                                                           | 2.96 ± 0.23 μs      |
| Weighted/scalar/construction                                                      | 2.79 ± 0.01 ns      |
| Weighted/scalar/logpdf                                                            | 1.73 ± 0.31 μs      |
| time_to_load                                                                      | 0.639 ± 0.0049 s    |
