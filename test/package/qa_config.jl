...
const QA_CONFIG = (
    ...
    # Path to the isolated formatter environment (see test/formatter/
    # Project.toml), which pins JuliaFormatter exactly so the check does not
    # float with the CI Julia in use.
    ...
    # non-publicly. The ConvolvedDistributions extension imports this
