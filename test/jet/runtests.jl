...
if @isdefined(JET_REPORT_FILTER)
    result = JET.report_package(ModifiedDistributions;
        target_modules = (ModifiedDistributions,))
    ...
    JET.test_package(ModifiedDistributions; target_modules = (ModifiedDistributions,))
end
