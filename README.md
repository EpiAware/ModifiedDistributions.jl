...
- [ConvolvedDistributions.jl](https://convolveddistributions.epiaware.org/stable/) sums independent delays and convolves count series; a package extension applies `thin`/`cumulative` to the convolved counts and lets modified distributions serve as convolution components.
